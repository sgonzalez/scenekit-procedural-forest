//
//  TriangleStripGeometryGeneratable.swift
//  Procedural Forest
//
...
/// A reference implementation for triangle strip generation.
class TriangleStripGeometryGeneratable: GeometryGeneratable, TriangleGenerator {
	...
	func addGeometryToRawGeometry(geo: inout RawGeometry, forLayer layer: String = "", at: SCNVector3 = SCNVector3Zero) {
		...
		geo.addGeometry(type: .triangleStrip, verts: verts, indices: indices, normals: normals, colors: colors, at: at)
	}
